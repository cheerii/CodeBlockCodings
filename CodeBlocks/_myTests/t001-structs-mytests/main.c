 ...
 *
 * \
 * \ Problem with: add_book(&Book2, "what you SHOULD see"); -> "what you should see" so local main char title[32] will not override
 * \ because the parameter is not title itself, instead it it a stream "what you should see".
...
////   Book2.book_id = 6495700;
    ...
    //printf("main:: Adresse von Obj-Book2 ist: %d\n\n", Book2);
    add_book(&Book2, "what you SHOULD see");
